...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl = proxyImageUrl(rawImage);
                ...
                children: [
                  ClipRRect(
                    ...
                    child: SizedBox(
                      ...
                      child: Container(
                        color: Colors.white,
                        child: rawImage.isNotEmpty
                            ? Image.network(
                                imageUrl,
                                fit: BoxFit.contain,
                                filterQuality: FilterQuality.high,
                                errorBuilder: (context, error, stackTrace) {
                                  debugPrint("PRODUCT CARD IMAGE FAIL RAW: $rawImage");
                                  debugPrint("PRODUCT CARD IMAGE FAIL PROXY: $imageUrl");
                                  return Container(
